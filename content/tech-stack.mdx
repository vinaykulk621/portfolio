...
description: 'In this blog i talk about the tech stack i am comfortable in.'
publishedAt: '2023-04-07'
keyWords: 'My Go-To Tech Stack, Vinay Kulkarni, Tech Stack, Next.js, TailwindCSS, MongoDB, Laziness, React, TailwindCSS, Databases, Supabase, PlanetScale, Python, C, Object-oriented programming, Polymorphism, Next.js framework repo, GitHub account, vinaykulk621, Svelte, Solid frameworks, Emojis, Joke, Programmer, Arrays, Good Day'
blog_count: '2'
---
