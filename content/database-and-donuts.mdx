...
keyWords: "Database and donuts, Vinay Kulkarni, DBMS, SQL, Cardinallity and it's ratio, Keys, Joins, Functional dependency, SQL, Extension and Intension, Super key, Candidate key, Primary key, Unique key, Foreign key, Locks, Shared Lock, Exclusive Lock, Prime and Non-Prime attributes, Partial dependency, Transitive dependency, Joins, Natural Join, Equi Join, Self Join, Left outter join, Right outter join, FULL outter join, Functional dependency, Closure set, Normalization, 1NF, 2NF, 3NF, BCNF, 4NF, ACID, Transaction, Dirty read problem, Unrepeatable read problem, Phantom read problem, Lost update problem, Schedule, Serial Schedule, Non Serail Schedule, Serializability, Conflict Serializable, View Serializable, Recoverable schedule, Strict schedule, Concurrancy control protocols, Timestamp protocol, Lock based, Views, TRIGGER, Index in SQL, SQL, DDL, DML, DCL, TCL, CREATE, DROP, ALTER, INSERT, UPDATE, DELETE, GRANT, REVOKE, COMMIT, Good Day"
