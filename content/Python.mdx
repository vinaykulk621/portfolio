...
<Callout>
  Working with **Tuples** is more **_memory_** and **_time_** efficient compared
  to working with **Lists**. to working with **Lists**. to working with
  **Lists**. to working with **Lists**.
</Callout>
---
...
<Callout>
  we can perform many operations on set like **_Union_**, **_intersection_**,
  and **_difference_**.
</Callout>
