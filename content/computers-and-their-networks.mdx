...
keyWords: 'Computers and their networks, Vinay Kulkarni, Computer Networks, Hub, Switch, Routers, Network Types, PAN, LAN, MAN, WAN, TCP/IP Model, Physical Layer, Data-Link Layer, Framing, Flow Control, Error Control, Access Control, Network Layer, IP Address, IPV4, Classfull Addressing, Classless Addressing, Subnetting, IPV6, Network Layer Protocols, ARP, ICMP, IGMP, Transport Layer, Error Control, Flow Control, Access Control, TCP, UDP, Application Layer, Application Layer Protocols, DHCP, Good Day'
