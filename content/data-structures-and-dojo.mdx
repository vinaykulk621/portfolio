...
description: 'The blog where i explain you the different data structures that are available and how we can use them with code.'
keyWords: 'Data structures, Binary Tree, Binary Search Tree, AVL Tree, Red-Black Tree, Preorder Traversal, Inorder Traversal, Postorder Traversal, Complete Binary Tree, Perfect Binary Tree, Single Linked List, Doubly Linked List, Circular Linked List, Circular Doubly Linked List, Stack, Push and Pop, Palindrome matching, Parentheses matching, Queue, Creation of deque, Insertion in deque, Deletion in deque, Rotation in deque, Doubly Linked List, Binary Tree, Deapth First Search, Breadth First Search, Sample graph, dfs, bfs, graph, src'
...
It is one of the most famous interview and [leetcode](https://leetcode.com/problems/two-sum/) question.
