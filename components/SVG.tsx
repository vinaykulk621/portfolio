  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger>
          <a
            className="text-sm transition dark:text-gray-500 dark:hover:text-gray-600"
            target="_blank"
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 20 20"
              className="h-6 w-6 fill-current  dark:text-gray-200 dark:hover:text-blue-500"
            >
        ...
        <TooltipContent className="border-none dark:bg-black dark:text-white">
  ...
  return (
    ...
    >
      ...
      <svg
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6 fill-current dark:text-gray-200 dark:hover:text-blue-400"
      >
  ...
  return (
    ...
    >
      <svg
        ...
        className="m-0 h-6 fill-current dark:text-gray-200 dark:hover:text-blue-400"
      >
...
//   return (
//     <TootipHelper toolTip="Tailwind css">
//       <div className="xs:p-3 mt-3 flex items-center gap-3 rounded-md bg-[#ffffff0a]/5 p-2">
...
//   return (
//     <TootipHelper toolTip="Bash/unix">
//       <div className="xs:p-3 mt-3 flex items-center gap-3 rounded-md bg-[#ffffff0a]/5 p-2">
