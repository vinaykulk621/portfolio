...
export default function PostPage(props) {
  ...
  return (
    <div className="min-w-screen flex min-h-screen flex-col items-center bg-[#111010] p-4 text-base text-white xs:text-sm">
      ...
      <article className="prose w-screen p-5 text-zinc-100 xs:prose-sm md:prose-lg lg:prose-xl prose-h1:text-white prose-h2:text-white prose-h3:text-white prose-h4:text-white prose-p:text-justify prose-p:font-spotify prose-blockquote:text-gray-400 prose-strong:text-white prose-code:text-cyan-400">
