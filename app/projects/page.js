    ...
    <>
      <div className="flex h-screen w-screen flex-col items-center justify-center bg-black font-spotify">
        ...
        <div className="flow-root items-center justify-center space-x-5 p-5">
          ...
          <a
            className="float-right text-xl text-gray-500 transition hover:text-gray-600"
            target="_blank"
          ...
          >
            ...
            <svg
              ...
              className="h-8 w-8 fill-current text-gray-700 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400"
            >
