     ...
     <main className="bg-black font-spotify">
       <div className="flex flex-col space-y-9 md:h-fit">
         <div className="grid grid-cols-1 justify-items-center space-y-5 text-white xs:space-y-5 md:grid-cols-2 md:gap-5 md:space-y-0 lg:m-10 lg:grid-cols-4 lg:gap-8">
           ...
           />
           <ProjectPallet
             DemoUrl={'https://clocko.vercel.app'}
             github_repo_name="vinaykulk621/clock"
             projectName="Digital Clock"
             projectDescription="A Simple digital clock that shows current time based on your current location."
             Preview={'clock.png'}
             alt="Digital Clock Project at https://github.com/vinaykulk621/clock"
           />
           <ProjectPallet
